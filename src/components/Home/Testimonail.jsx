...
export default function TestimonialsSection() {
  const testimonials = [
    {
      name: "Emma Davis",
      text: `SterlingSpace transformed my home with meticulous care, delivering spotless results every time.`,
      rating: 5,
    },
    {
      name: "LaiylaS",
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-10 transition-all duration-500 ease-in-out">
        ...
        <div
          ...
          data-aos="fade-right"
        >
          <h2 className="uppercase font-semibold   dark:text-gray-100 mb-3">
