  ...
  const services = [
    {
      ...
      description:
        "Thorough cleaning that targets every corner to refresh your living space completely.",
      image: "/s1.jpg",
    ...
    },
    {
      ...
      description:
        "Consistent, dependable cleaning to maintain a pristine and welcoming environment.",
      image: "/s2.jpg",
    ...
    },
    {
      ...
      description:
        "Specialized cleaning ensuring your property is immaculate for moving out or new tenants.",
      image: "/s5.jpg",
    ...
    >
      ...
      <div className="max-w-6xl mx-auto mb-16">
        <div className="text-center mb-4 ">
          <h2 className="font-bold text-lg dark:text-gray-100  tracking-widest uppercase mb-2">
            • Our Services
          </h2>
        </div>
